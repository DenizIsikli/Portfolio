...
const About: FC = () => {
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl px-4 mx-auto">
        <motion.div
        ...
        >
          <div className="relative group">
            ...
            <div className="relative w-full max-w-xl overflow-hidden rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm shadow-lg group-hover:shadow-xl transition-all duration-500">
              <motion.img
                src={profile.image || Portrait}
                alt="Bobby"
